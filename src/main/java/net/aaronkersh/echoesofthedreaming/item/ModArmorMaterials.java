...
public enum ModArmorMaterials implements ArmorMaterial {
    BISMUTH("bismuth", 25, new int[] { 3, 8, 6, 3 }, 8,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 0f, 0.1f, () -> Ingredient.ofItems(ModItems.BISMUTH));
    ...
    public String getName() {
        return EchoesOfTheDreaming.MOD_ID + ":" + this.name;
    }
