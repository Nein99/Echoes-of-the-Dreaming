...
// Custom Mournsteel Pickaxe
public class MournsteelPickaxeItem extends PickaxeItem {
    ...
    public MournsteelPickaxeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Item.Settings settings) {
