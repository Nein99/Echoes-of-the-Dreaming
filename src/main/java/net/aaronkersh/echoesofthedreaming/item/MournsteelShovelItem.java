...
public class MournsteelShovelItem extends ShovelItem {
    ...
    public MournsteelShovelItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Item.Settings settings) {
